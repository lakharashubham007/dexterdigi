      ...
      <div className="container relative ">
        ...
        <div className="relative mx-auto max-md:mb-20 max-md:mt-20 max-md:h-[220px] max-md:w-full md:mb-32 md:mt-25 md:max-w-[650px] lg:max-w-[750px] xl:max-w-[1020px]">
          <Image
            src={bannerLight}
            alt="about images"
            className="w-full dark:hidden max-md:h-full"
          />
          <Image
            src={bannerDark}
            alt="about images"
            className="hidden w-full max-md:h-full md:dark:inline-block"
          />
          <div className="absolute bottom-[18px] left-1/2 mx-auto w-150 -translate-x-1/2 sm:bottom-6 md:w-[250px] lg:bottom-7 lg:w-[250px] xl:bottom-[38px] xl:w-[308px] ">
            <Image
              src={bannerDeviceLight}
              alt="about images"
              className=" w-full dark:hidden "
            />
            <Image
              src={bannerDeviceDark}
              alt="about images"
          ...
          <FadeUpAnimation className="absolute -right-5 bottom-10 mx-auto aspect-auto w-150 sm:-right-15 sm:w-[250px] lg:-right-150 lg:w-[300px] xl:w-[380px]">
            <Image
              src={bannerShapeOneLight}
              alt="about images"
              className=" w-full dark:hidden"
            />
            <Image
              src={bannerShapeOneDark}
              alt="about images"
              className="hidden w-full dark:inline-block"
            />
          </FadeUpAnimation>
          <FadeUpAnimation className="absolute -left-5 top-10 mx-auto aspect-auto w-150 sm:-left-15 sm:w-[250px] lg:-left-150 lg:w-[300px] xl:w-[380px]">
            <Image
              src={bannerShapeTwoLight}
              alt="about images"
              className="w-full dark:hidden"
            />
            <Image
              src={bannerShapeTwoDark}
              alt="about images"
              className="hidden w-full dark:inline-block"
            />
          </FadeUpAnimation>
