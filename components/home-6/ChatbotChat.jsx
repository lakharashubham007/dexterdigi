      ...
      <div className="container relative z-10">
        <div className="grid grid-cols-2 gap-25 max-md:grid-cols-1 1xl:gap-x-24">
          <div className="relative  py-10 ">
            ...
            <h2 className="mb-8">
              Instant chat for outstanding customer experiences.
            </h2>
            <p className="mb-12">
              Provide live chat support to your customers. Our chatbot
              effortlessly hands off to human agents when necessary.
            </p>
          ...
          <div className="relative">
            ...
            >
              <Image
                src={chatbotChatImage}
                alt="explore"
                className="rounded-medium dark:hidden"
              />
              <Image
                src={chatbotChatImageDark}
                alt="explore"
            ...
            >
              <Image
                src={chatbotChatImageSummery}
                alt="summery"
                className=" dark:hidden "
              />
              <Image
                src={chatbotChatImageSummeryDark}
                alt="summery"
            ...
            >
              <Image
                src={chatbotChatImageExpense}
                alt="summery"
                className="dark:hidden"
              />
              <Image
                src={chatbotChatImageExpenseDark}
                alt="summery"
                className="hidden dark:inline-block"
              />
            </motion.div>
            ...
            >
              <Image
                src={chatbotChatImagePayment}
                alt="summery"
                className="dark:hidden "
              />
              <Image
                src={chatbotChatImagePaymentDark}
                alt="summery"
                className="hidden dark:inline-block"
              />
            </motion.div>
