...
const Feature = () => {
  const userManageCard = [
    {
      ...
      description:
        'Chatbots can engage website visitors, qualify leads, and capture contact information',
    },
    {
      id: 2,
      img: data2,
  ...
  return (
    <section className="relative bg-white pb-20 dark:bg-dark-300">
            ...
            >
              <div className="h-full rounded border border-dashed border-gray-100 p-10 dark:border-borderColor-dark max-lg:p-5">
                <Image
                  src={userCard.img}
                  alt="image"
                  className="mb-10 inline-block w-full rounded dark:hidden"
                />
                <Image
                  src={userCard.darkImg}
                  alt="image"
                  className="mb-10 hidden w-full rounded dark:inline-block"
                />
