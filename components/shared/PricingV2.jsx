...
const PricingV2 = ({
  ...
  return (
    <section
      className={cn(
        'relative -z-0 overflow-hidden bg-white dark:bg-dark-300',
        className
      )}
    >
      <div className="container">
        <div
          className={`${largeTitle ? 'max-w-[900px]' : ''} z-100 relative mx-auto mb-12 text-center`}
        >
          <div className={cn(showPricingText ? '' : 'hidden')}>
            ...
            {pricingDescription ? (
              <p className="mb-12 mt-10">
                Whether you&lsquo;re an individual, a small team, or a growing
                enterprise, we have a <br /> plan that aligns perfectly with
                your goals.
              </p>
            ) : (
              ''
